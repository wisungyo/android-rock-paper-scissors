package com.binar.ccgameandprofile.ingame
...
import com.binar.ccgameandprofile.databinding.ActivityMainBinding
import kotlinx.android.synthetic.main.activity_main.*

class VsComputer : AppCompatActivity() {
    private val comArray: Array<String> = arrayOf("rock", "paper", "scissors")
...
//        val view = binding.root
        ...
        binding.ivComRock.setOnClickListener {
            ...
            Log.d("ERROR", "Do not choose COM side. Choose YOU side.")
        }
    ...
    private fun alertTouchingComIcons() {
        tv_status.text = "" // show status empty string
        // ALERT FOR YOU ICONS
