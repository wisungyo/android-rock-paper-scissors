...
public final class ActivityIntroBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout clFragmentContent;

  private ActivityIntroBinding(@NonNull ConstraintLayout rootView,
      @NonNull ChipNavigationBar bottomNavigation, @NonNull ConstraintLayout clFragmentContent) {
    this.rootView = rootView;
    this.bottomNavigation = bottomNavigation;
    this.clFragmentContent = clFragmentContent;
  }
  ...
  public static ActivityIntroBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.cl_fragment_content;
      ConstraintLayout clFragmentContent = rootView.findViewById(id);
      if (clFragmentContent == null) {
        break missingId;
      }

      return new ActivityIntroBinding((ConstraintLayout) rootView, bottomNavigation,
          clFragmentContent);
    }
