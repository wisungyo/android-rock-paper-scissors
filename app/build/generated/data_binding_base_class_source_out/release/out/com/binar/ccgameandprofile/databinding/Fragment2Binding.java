...
public final class Fragment2Binding implements ViewBinding {
  ...
  private Fragment2Binding(@NonNull ConstraintLayout rootView, @NonNull Button btnFragment2,
  ...
  public static Fragment2Binding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.btn_fragment_2;
      Button btnFragment2 = rootView.findViewById(id);
      ...
      return new Fragment2Binding((ConstraintLayout) rootView, btnFragment2, guideline, ivIntro3,
          tvIntro1);
    }
